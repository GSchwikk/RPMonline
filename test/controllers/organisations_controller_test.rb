...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { image: @organisation.image, industry: @organisation.industry, name: @organisation.name }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { image: @organisation.image, industry: @organisation.industry, name: @organisation.name }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
